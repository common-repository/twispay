...
$tw_lang['transactions_sync_label'] = 'Update transactions list';
$tw_lang['transactions_sync_desc'] = 'Updates the corespondence between twispay transactions and woocomerce orders.';
$tw_lang['transactions_sync_button'] = 'Update';
