        ...
        if ( isset( $_GET['action'] ) && sanitize_text_field( $_GET['action'] ) ) {
            ...
            ?>
                <div class="wrap">
                    ...
                    <form method="post" id="synchronize_transactions">
                        <table class="form-table">
                            <tr class="form-field" id="contact_email_o">
                                <th scope="row"><label><?= esc_html( $tw_lang['transactions_sync_label'] ); ?></span></label></th>
                                <td>
                                    <input type="hidden" name="tw_general_action" value="synchronize_transactions" />
                                    <?php submit_button( esc_attr( $tw_lang['transactions_sync_button'] ), 'primary', 'createuser', true, array( 'id' => 'synchronizetransactions' ) ); ?>
                                    <p class="description"><?= esc_html( $tw_lang['transactions_sync_desc'] ); ?></p>
                                </td>
                            </tr>
                        </table>
                    </form>
